...
import type { IconComponent } from "../../lib/ff/icons";
import { cn } from "../../lib/utils";
import { springs } from "../../motion/springs";
import { fontWeights } from "../../lib/ff/font-weight";
import { useShape } from "../../lib/ff/shape-context";
import { useSurface } from "../../lib/ff/surface-context";
import { surfaceClasses } from "../../lib/ff/surface-classes";
        ...
        >
          ...
          <AnimatePresence>
            {focusRect && (
              <motion.div
                className={cn(
                  "absolute pointer-events-none z-20 border border-[var(--ring)]",
                  shape.focusRing
                )}
                initial={false}
                animate={{
